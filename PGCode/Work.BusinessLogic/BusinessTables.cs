...
namespace ProcCore.Business.Logic.TablesDescription
{
    ...
    ///網頁資料
    ///</summary>
    public class PageData : TableMap<PageData>
    {
        public PageData() { N = "網頁"; GetTabObj = this; KeyFieldModules = new Dictionary<String, FieldModule>() { { this.id.N, this.id }}; }
        public FieldModule id = new FieldModule() { M = "id", N = "id", T = SQLValueType.Int };
    ...
    public class Schools : TableMap<Schools>
    {
        public Schools() { N = "學院"; GetTabObj = this; KeyFieldModules = new Dictionary<String, FieldModule>() { { this.id.N, this.id }}; }
        public FieldModule id = new FieldModule() { M = "id", N = "id", T = SQLValueType.Int };
        public FieldModule kid = new FieldModule() { M = "kid", N = "kid", T = SQLValueType.Int };
        public FieldModule name = new FieldModule() { M = "name", N = "名稱", T = SQLValueType.String };
        public FieldModule sort = new FieldModule() { M = "sort", N = "排序", T = SQLValueType.Int };
        public FieldModule pagecontext = new FieldModule() { M = "pagecontext", N = "網頁內容", T = SQLValueType.String };
        public FieldModule _隱藏 = new FieldModule() { M = "_隱藏", N = "_隱藏", T = SQLValueType.Boolean };
        public FieldModule _新增人員 = new FieldModule() { M = "_新增人員", N = "_新增人員", T = SQLValueType.Int };
    ...
    public class Department : TableMap<Department>
    {
        public Department() { N = "學系"; GetTabObj = this; KeyFieldModules = new Dictionary<String, FieldModule>() { { this.ids.N, this.ids }}; }
        public FieldModule ids = new FieldModule() { M = "ids", N = "id", T = SQLValueType.Int };
        public FieldModule kid = new FieldModule() { M = "kid", N = "kid", T = SQLValueType.Int };
        public FieldModule zip = new FieldModule() { M = "zip", N = "zip", T = SQLValueType.String };
        public FieldModule name = new FieldModule() { M = "name", N = "名稱", T = SQLValueType.String };
        public FieldModule sort = new FieldModule() { M = "sort", N = "排序", T = SQLValueType.Int };
    ...
    public class 消息D : TableMap<消息D>
    {
        public 消息D() { N = "消息"; GetTabObj = this; KeyFieldModules = new Dictionary<String, FieldModule>() { { this.id.N, this.id }}; }
        public FieldModule id = new FieldModule() { M = "id", N = "id", T = SQLValueType.Int };
